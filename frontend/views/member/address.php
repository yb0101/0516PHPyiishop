...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <?php foreach ($address?$address:[] as $addres):?>
            <dl class="last" data-id="<?=$addres->id?>"> <!-- 最后一个dl 加类last -->
                <dt><?=$addres->username.$addres->tel.$addres->province.$addres->city.$addres->area.$addres['address']?></dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['member/edit','id'=>$addres->id])?>">修改</a>
                    <a href="javaseript:;" class="del_btn">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
            <?php endforeach;?>
...
<?php
//注册JS代码
$url_del=\yii\helpers\Url::to(['address/delete']);
$this->registerJs(new \yii\web\JsExpression(
<<<JS
        $(".del_btn").click(function() {

if(confirm("真的想好删除了吗？")){
var dd =$(this).closest('dl');//往上找父节点

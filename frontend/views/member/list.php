    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            ...
            <ul>
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['member/alist','id'=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['member/alist','id'=>$good->id])?>"><?=$good->name?></a></dt>
                        <dd><strong><?=$good->shop_price?></strong></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['member/alist','id'=>$good->id])?>"><em><?=$good->view_times?></em></a></dt>
                    </dl>
                </li>
            </ul>
            <?php endforeach;?>
